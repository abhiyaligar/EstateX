      ...
      <Card noPadding className="overflow-hidden">
        <div className="p-8 border-b border-border flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-foreground/40 mt-1 uppercase tracking-widest">Global Market Telemetry Database</p>
          </div>
          <Button 
            variant="primary" 
            size="sm" 
              ...
              <AdminTableRow key={macro.pincode}>
                ...
                <AdminTableCell>
                  <div className="flex items-center gap-4 min-w-[120px]">
                     <div className="flex-1 h-1.5 bg-foreground/5 rounded-full overflow-hidden border border-border">
                        <motion.div 
                          initial={{ width: 0 }}
                ...
                <AdminTableCell>
                  <span className="text-[10px] text-foreground/30 uppercase font-medium">
                ...
                <AdminTableCell align="right">
                   <div className="flex justify-end gap-2">
                    <Button 
                      variant="ghost" 
                      className="h-9 w-9 p-0 hover:bg-foreground/5"
                      onClick={() => onEdit(macro)}
                      title="Edit Node"
                    >
                      <Edit2 size={16} className="text-foreground/20 hover:text-foreground transition-colors" />
                    </Button>
                    <Button 
                      variant="ghost" 
