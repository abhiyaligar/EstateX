    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-black/40 dark:text-white/40 uppercase tracking-widest">Protocol Adoption & Volume Matrix</p>
                </div>
              </div>
              <div className="flex bg-black/5 dark:bg-black/5 dark:bg-white/5 p-1 rounded-lg">
                <button 
                  onClick={() => setChartMetric('volume')}
                  className={`px-3 py-1 text-[8px] font-bold uppercase tracking-widest rounded transition-colors ${chartMetric === 'volume' ? 'bg-black/10 dark:bg-black/10 dark:bg-white/10 text-foreground' : 'text-black/40 dark:text-white/40 hover:text-foreground'}`}
                >
                  Volume
                </button>
                <button 
                  onClick={() => setChartMetric('users')}
                  className={`px-3 py-1 text-[8px] font-bold uppercase tracking-widest rounded transition-colors ${chartMetric === 'users' ? 'bg-black/10 dark:bg-black/10 dark:bg-white/10 text-foreground' : 'text-black/40 dark:text-white/40 hover:text-foreground'}`}
                >
                  Users
                </button>
              </div>
         ...
         <Card className="lg:col-span-4 p-8 flex flex-col items-center justify-center text-center">
            <h4 className="text-xs font-bold uppercase tracking-[0.2em] mb-8 text-black/40 dark:text-white/40">Capital Distribution</h4>
            <div className="h-[240px] w-full relative">
               ...
               <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  <span className="text-[10px] uppercase tracking-widest text-black/30 dark:text-white/30">Total</span>
            ...
            <div className="grid grid-cols-3 gap-2 w-full mt-6">
               {pieData.map(item => (
                 <div key={item.name} className="flex flex-col items-center">
                    ...
                    <span className="text-[8px] uppercase tracking-widest text-black/40 dark:text-white/40">{item.name}</span>
                 </div>
               ))}
            </div>
         </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="p-8">
             ...
             <div className="grid grid-cols-2 gap-3">
                <Button variant="outline" className="text-[9px] h-12 uppercase tracking-widest border-black/5 dark:border-white/5 hover:bg-black/5 dark:bg-black/5 dark:bg-white/5">Export Audit</Button>
                <Button variant="outline" className="text-[9px] h-12 uppercase tracking-widest border-black/5 dark:border-white/5 hover:bg-black/5 dark:bg-black/5 dark:bg-white/5">Flush Cache</Button>
                <Button variant="outline" className="text-[9px] h-12 uppercase tracking-widest border-black/5 dark:border-white/5 hover:bg-black/5 dark:bg-black/5 dark:bg-white/5">Sync Chain</Button>
                <Button variant="outline" className="text-[9px] h-12 uppercase tracking-widest border-black/5 dark:border-white/5 hover:bg-black/5 dark:bg-black/5 dark:bg-white/5">Force Refresh</Button>
             </div>
          </Card>
          ...
          <Card className="lg:col-span-2 bg-gradient-to-br from-red-500/5 to-transparent border-red-500/10 p-8 flex items-center justify-between">
              <div className="space-y-4 max-w-md">
                 ...
                 <p className="text-xs text-black/40 dark:text-white/40 leading-relaxed uppercase tracking-widest">
