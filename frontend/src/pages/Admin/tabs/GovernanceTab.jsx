...
import { Plus, Building2, Gavel, ShieldCheck } from 'lucide-react';
      ...
      <Card noPadding className="overflow-hidden">
        <div className="p-8 border-b border-black/5 dark:border-white/5 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-black/40 dark:text-white/40 mt-1 uppercase tracking-widest">Execute Decentralized Consensus Decisions</p>
          </div>
          <Button 
            variant="primary" 
            size="sm" 
                  ...
                  <AdminTableRow key={p.id}>
                    <AdminTableCell>
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 bg-black/5 dark:bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg flex items-center justify-center text-black/20 dark:text-white/20">
                           <Building2 size={16} />
                        </div>
                        <div className="flex flex-col">
                          <span className="text-[11px] font-bold text-foreground uppercase tracking-wider">{proj?.title || 'Unknown Protocol'}</span>
                          <span className="text-[9px] text-black/30 dark:text-white/30 font-mono">ID: {p.project_id.substring(0,8)}</span>
                        </div>
                      </div>
                    </AdminTableCell>
                    <AdminTableCell>
                    ...
                    <AdminTableCell>
                       <div className="flex flex-col">
                         ...
                         <span className="text-[9px] text-black/30 dark:text-white/30 uppercase font-bold tracking-widest">BRICKS VOTE</span>
                       </div>
                    </AdminTableCell>
                    <AdminTableCell>
