      ...
      <Card noPadding className="overflow-hidden">
        <div className="p-8 border-b border-border flex justify-between items-center">
          <div>
            ...
            <p className="text-xs text-foreground/40 mt-1 uppercase tracking-widest">Execute monthly distributions & protocol fee harvests</p>
          </div>
          <Button 
            variant="outline" 
                ...
                <AdminTableRow key={cycle.id}>
                  ...
                  <AdminTableCell>
                    <div className="flex flex-col">
                      ...
                      <span className="text-[8px] text-foreground/20 uppercase font-bold">1% HARVEST</span>
                    </div>
                  </AdminTableCell>
                  <AdminTableCell>
