  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/95 backdrop-blur-md p-4 animate-in fade-in duration-300">
      ...
      <div className="max-w-4xl w-full flex flex-col items-center">
        <img src={imageUrl} alt={title} className="max-h-[80vh] w-auto border border-white/10 shadow-2xl" />
        <h3 className="mt-6 text-[10px] uppercase tracking-[0.4em] font-bold text-white/40">{title}</h3>
      </div>
    </div>
  );
};
