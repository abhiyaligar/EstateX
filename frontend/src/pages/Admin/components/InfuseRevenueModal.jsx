    ...
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/95 backdrop-blur-md p-4">
       <Card className="max-w-md w-full bg-background border-black/10 dark:border-white/10 shadow-2xl">
          <CardHeader className="border-b border-black/5 dark:border-white/5">
            ...
            <p className="text-[10px] uppercase tracking-widest text-black/40 dark:text-white/40 mt-1">Directly inject rental income into the settlement queue</p>
          </CardHeader>
          <CardContent className="p-6">
            <form onSubmit={onSubmit} className="space-y-6">
               <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-widest text-black/40 dark:text-white/40 font-bold">Target Project</label>
                  <select 
               ...
               <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                     <label className="text-[10px] uppercase tracking-widest text-black/40 dark:text-white/40 font-bold">Month</label>
                     <select 
                       className="w-full bg-black/5 dark:bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 p-3 text-sm text-foreground focus:border-primary-500 outline-none"
                  ...
                  <div className="space-y-2">
                     <label className="text-[10px] uppercase tracking-widest text-black/40 dark:text-white/40 font-bold">Year</label>
                     <Input 
                       type="number"
