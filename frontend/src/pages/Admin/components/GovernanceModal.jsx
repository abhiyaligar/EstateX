...
const GovernanceModal = ({ isOpen, onClose, projects, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-background/95 backdrop-blur-sm p-4 animate-in fade-in duration-300">
      <Card className="max-w-xl w-full bg-background border-border shadow-2xl">
        ...
        <CardContent className="p-6 max-h-[70vh] overflow-y-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-foreground/40">Select Asset</label>
              <select 
                className="w-full bg-foreground/5 border border-border p-3 text-sm font-mono text-foreground outline-none focus:border-primary-500"
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-foreground/40">Proposal Title</label>
              <Input 
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-foreground/40">Description & Rationale</label>
              <textarea 
                className="w-full bg-foreground/5 border border-border p-4 text-sm text-foreground focus:border-primary-500 outline-none min-h-[100px]"
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <label className="text-[10px] uppercase tracking-widest text-foreground/40">Voting Options</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest text-foreground/40">Voting Deadline</label>
              <Input 
                type="datetime-local"
