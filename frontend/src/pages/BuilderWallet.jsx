                    ...
                    <Card className="bg-slate-900 text-foreground border-none shadow-xl relative overflow-hidden group">
                        ...
                        <CardContent className="p-10 relative z-10">
                            <div className="flex justify-between items-start mb-12">
                                ...
                                <div className="bg-black/10 dark:bg-black/10 dark:bg-white/10 p-4 rounded-2xl backdrop-blur-md border border-black/10 dark:border-white/10">
                        ...
                        <CardContent className="p-8 relative z-10">
                            ...
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center gap-3 text-sm text-indigo-50">
                                    <div className="h-5 w-5 rounded-full bg-black/20 dark:bg-white/20 flex items-center justify-center text-[10px] font-bold">1</div>
                                    Verify project milestone
                                </li>
                                <li className="flex items-center gap-3 text-sm text-indigo-50">
                                    <div className="h-5 w-5 rounded-full bg-black/20 dark:bg-white/20 flex items-center justify-center text-[10px] font-bold">2</div>
                                    Funds land in Business Wallet
                                </li>
                                <li className="flex items-center gap-3 text-sm text-indigo-50">
                                    <div className="h-5 w-5 rounded-full bg-black/20 dark:bg-white/20 flex items-center justify-center text-[10px] font-bold">3</div>
