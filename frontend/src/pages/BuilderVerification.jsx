        ...
        <div className="min-h-screen bg-background text-foreground py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="text-black/40 dark:text-white/40 uppercase tracking-[0.2em] text-xs">Verify your identity to begin property tokenization</p>
                </div>
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        {activeStep === 1 && (
                            <Card className="p-8 space-y-6">
                                <div className="flex items-center gap-3 mb-4">
                                    <Briefcase className="text-black/20 dark:text-white/20" size={24} />
                        ...
                        {activeStep === 3 && (
                            <Card className="p-8 space-y-6">
                                <div className="flex items-center gap-3 mb-4">
                                    <FileText className="text-black/20 dark:text-white/20" size={24} />
                                    <h2 className="text-xl font-bold uppercase tracking-tight">Document References</h2>
                                </div>
                                <p className="text-xs text-black/40 dark:text-white/40 uppercase tracking-widest leading-relaxed mb-6">Provide the hosted links or reference numbers for your verification documents. These will be audited by the EstateX team.</p>
                        ...
                        {activeStep === 4 && (
                            <Card className="p-8 space-y-6">
                                <div className="flex items-center gap-3 mb-4">
                                    <CreditCard className="text-black/20 dark:text-white/20" size={24} />
                                    <h2 className="text-xl font-bold uppercase tracking-tight">Node Financial Nexus</h2>
                                </div>
                                <p className="text-xs text-black/40 dark:text-white/40 uppercase tracking-widest leading-relaxed mb-6">This bank account will be used as the primary settlement node for all construction fund releases.</p>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <Input 
                        ...
                        {activeStep === 5 && (
                            <Card className="p-8 space-y-8">
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-sm text-black/40 dark:text-white/40 max-w-md mx-auto">Please confirm that all provided data is accurate to within 100% precision. Misrepresentation will result in immediate node suspension.</p>
                                </div>

                                <div className="grid grid-cols-2 gap-y-4 text-xs border-t border-b border-black/5 dark:border-white/5 py-8 uppercase tracking-widest">
                                    <span className="text-black/20 dark:text-white/20">Entity</span>
                                    <span className="text-right font-bold">{formData.company_name}</span>
                                    <span className="text-black/20 dark:text-white/20">RERA ID</span>
                                    <span className="text-right font-bold font-mono">{formData.rera_registration_number}</span>
                                    <span className="text-black/20 dark:text-white/20">Tax Node</span>
                                    <span className="text-right font-bold font-mono">{formData.pan_number}</span>
                                    <span className="text-black/20 dark:text-white/20">Settlement</span>
