  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-background text-foreground overflow-hidden font-sans">
      ...
      <motion.aside 
        ...
        className="hidden md:flex flex-col border-r border-black/5 dark:border-white/5 bg-background relative z-50"
      >
        <div className={`p-6 flex items-center ${isSidebarCollapsed ? 'justify-center' : 'justify-between'}`}>
          ...
          <button 
            ...
            className={`p-2 hover:bg-black/5 dark:bg-white/5 rounded-lg text-zinc-600 dark:text-zinc-400 hover:text-foreground transition-colors ${isSidebarCollapsed ? 'mx-auto' : ''}`}
          >
          ...
          {sidebarItems.map((item) => (
            <button
              ...
              className={`w-full flex items-center ${isSidebarCollapsed ? 'justify-center' : 'gap-4 px-4'} py-3 rounded-xl transition-all duration-300 group relative ${
                ...
                : 'text-zinc-600 dark:text-zinc-400 hover:bg-black/5 dark:bg-white/5 hover:text-foreground'
              }`}
            >
        ...
        <div className={`p-4 border-t border-black/5 dark:border-white/5 space-y-4 ${isSidebarCollapsed ? 'flex flex-col items-center' : ''}`}>
           {!isSidebarCollapsed && (
             <div className="p-4 bg-black/5 dark:bg-white/5 rounded-2xl flex items-center gap-3">
               ...
               <div className="flex-1 min-w-0">
                 ...
                 <p className="text-[10px] text-zinc-500 dark:text-zinc-500 truncate">Super Protocol Level 4</p>
               </div>
             </div>
           )}
      ...
      {/* Mobile Header */}
      <header className="md:hidden fixed top-0 left-0 right-0 h-16 bg-background/80 backdrop-blur-xl border-b border-black/5 dark:border-white/5 z-[60] flex items-center justify-between px-4">
        ...
        <button onClick={() => setIsMobileMenuOpen(true)} className="p-2 text-zinc-700 dark:text-zinc-300 hover:text-foreground">
          <Menu size={24} />
        </button>
      </header>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="p-6 flex items-center justify-between border-b border-black/5 dark:border-white/5">
              ...
              <button onClick={() => setIsMobileMenuOpen(false)} className="p-2 text-zinc-700 dark:text-zinc-300"><X size={24}/></button>
            </div>
              ...
              {sidebarItems.map(item => (
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-xl ${
                    activeTab === item.id ? 'bg-primary-600 text-foreground' : 'text-zinc-600 dark:text-zinc-400'
                  }`}
                >
                  <item.icon size={24} />
      ...
      <main className="flex-1 flex flex-col min-w-0 min-h-0 relative overflow-hidden">
        {/* Top bar */}
        <header className="hidden md:flex h-20 items-center justify-between px-6 lg:px-10 border-b border-black/5 dark:border-white/5 bg-background/50 backdrop-blur-md sticky top-0 z-40">
           <div>
              <h2 className="text-xs uppercase tracking-[0.4em] font-bold text-zinc-500 dark:text-zinc-500 flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary-500 animate-pulse" />
                Network Status: Operational
              </h2>
              <div className="flex items-center gap-2 mt-1">
                 <span className="text-zinc-500 dark:text-zinc-500 text-[10px] uppercase tracking-widest">Protocol</span>
                 <span className="text-zinc-600 dark:text-zinc-400 text-[10px] uppercase tracking-widest">/</span>
           ...
           <div className="flex items-center gap-6">
              <div className="relative group">
                 <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-500 dark:text-zinc-500 group-focus-within:text-primary-500 transition-colors" size={16} />
                 <input 
                  type="text" 
                  placeholder="Universal Protocol Search..." 
                  className="bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-full py-2 pl-10 pr-4 text-xs w-64 outline-none focus:border-primary-500/50 focus:bg-white/[0.07] transition-all"
                 />
              </div>
              <button className="relative p-2 text-zinc-600 dark:text-zinc-400 hover:text-foreground transition-colors">
                <Bell size={20} />
                <span className="absolute top-2 right-2 w-2 h-2 bg-red-500 rounded-full border-2 border-[#050505]" />
              </button>
              <button className="p-2 text-zinc-600 dark:text-zinc-400 hover:text-foreground transition-colors">
                <Settings size={20} />
              </button>
           </div>
        </header>
